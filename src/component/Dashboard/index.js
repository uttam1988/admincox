...
const DashboardComponent = () => {
    const [profileDropDown, openProfileDropDown] = useState(false);
    return (
            ...
            <div id="wrapper">
                <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                    <a className="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                        ...
                        <div className="sidebar-brand-text mx-3">COX</div>
                    </a>
                        ...
                        <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                            ...
                            <ul className="navbar-nav ml-auto">
                                ...
                                <li className="nav-item dropdown no-arrow">
                                    <div className="nav-link dropdown-toggle" onClick={() => openProfileDropDown(true)}  id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <span className="mr-2 d-none d-lg-inline text-gray-600 small">Irfan Test</span>
                                        <img className="img-profile rounded-circle" src="https://source.unsplash.com/QAB-WJcbgJk/60x60" />
                                    </div>
                                    <div className={`dropdown-menu dropdown-menu-right shadow animated--grow-in ${profileDropDown && 'show'}`} aria-labelledby="userDropdown">
